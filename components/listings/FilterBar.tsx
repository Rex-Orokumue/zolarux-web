...
export default function FilterBar() {
  ...
  const facets = (
    <div className="space-y-6">
      <div>
        <label className="block text-xs font-700 text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Condition</label>
      ...
      <div>
        <label className="block text-xs font-700 text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Brand</label>
        <input
          type="text"
      ...
      <div>
        <label className="block text-xs font-700 text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Price Range (₦)</label>
      ...
      <div>
        <label className="block text-xs font-700 text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Sort By</label>
        <select
          value={activeSort}
    ...
    <div>
      <form onSubmit={handleSearchSubmit} className="flex gap-2">
        ...
        <button
          ...
          className="lg:hidden shrink-0 w-11 h-11 border border-gray-200 dark:border-gray-700 rounded-xl flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all"
      ...
      <div className="hidden lg:block mt-6 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
        {facets}
      </div>
      ...
      {drawerOpen && (
        <div className="lg:hidden fixed inset-0 z-50 flex items-end">
          ...
          <div className="relative w-full bg-white dark:bg-gray-900 rounded-t-3xl p-5 max-h-[80vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-display font-700 text-gray-900 dark:text-gray-100">Filters</h3>
              <button
